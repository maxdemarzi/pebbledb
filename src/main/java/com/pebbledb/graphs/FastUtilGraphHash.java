...
public class FastUtilGraphHash {
    ...
    public boolean removeNode(String key) {
        ...
        if(keys.containsKey(key)) {
            ...
            for (String type : related.keySet()) {
                ReversibleMultiMapHash rels = related.get(type);
                int outgoingCount = 0;
                int incomingCount = 0;
    ...
    public boolean addRelationship(String type, String from, String to) {
        related.putIfAbsent(type, new ReversibleMultiMapHash());
